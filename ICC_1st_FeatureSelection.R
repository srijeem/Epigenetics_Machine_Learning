...
### 1st Feature Selection Step to remove unstable probes 
...
targets$Longitudinal_DNA_Data = as.factor(targets$Longitudinal_DNA_Data)
targets$T1_HTN = as.factor(targets$T1_HTN)
targets$T2_HTN = as.factor(targets$T2_HTN)
...
# Convert relevant columns to factors
traintargets$Longitudinal_DNA_Data = as.factor(traintargets$Longitudinal_DNA_Data)
traintargets$T1_HTN = as.factor(traintargets$T1_HTN)
traintargets$T2_HTN = as.factor(traintargets$T2_HTN)
